...
Now let's work on making our map pretty with some colors. Inside our `geom_sf()` parentheses, we can add our own colors to our map. The argument `fill` add color to our polygons, and `color` is the color of our lines. `size` refers to the size of our lines. ggplot() + 
  geom_sf(data = world_without_antarctica) +
    ggtitle("Countries of the World", subtitle = "without Antarctica")
